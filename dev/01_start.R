...
##
golem::fill_desc(
  pkg_name = "bs4dash", # The name of the golem package containing the app (typically lowercase, no underscore or periods)
  ...
  authors = person(
    given = "Masoud", # Your First Name
    family = "Faridi", # Your Last Name
    email = "MASOUD1FARIDI@GMAIL.COM", # Your email
